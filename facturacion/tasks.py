...
def generar_pdf_factura(factura_id):
    ...
    # Renderiza el HTML con los datos de la factura
    ...
    # Guarda el PDF en media/facturas/
...
def enviar_recordatorios_pago():
    ...
    # Fecha objetivo: 3 días a partir de hoy
    fecha_objetivo = timezone.localdate() + timedelta(days=3)

    # Facturas que vencen ese día y no están pagadas
